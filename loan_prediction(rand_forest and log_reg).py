...
logRegPredFormat=["Y" if i==1 else "N" for i in logReg_test_pred]
pd.DataFrame({'Loan_ID':testnew.Loan_ID,'Loan_Status':logRegPredFormat}).to_csv('logistic_regression_submission.csv',index=False)
result2=pd.read_csv('logistic_regression_submission.csv')
#print(result2)
